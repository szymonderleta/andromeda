...
public class ImageUpdaterImpl implements ImageUpdater {
     ...
     */
    private boolean createDirectoryIfNotExists(final String path) {
     ...
     */
    private void saveImageAsJpg(final MultipartFile image, final File directory, final long userId) throws IOException {
