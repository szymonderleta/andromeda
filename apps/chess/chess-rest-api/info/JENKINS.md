    ...
    stages {
        stage('Checkout') {
            steps {
                ...
                url: 'git@github.com:szymonderleta/chess-rest-api-public.git'
            }
        }
        ...
        stage('Rename WAR File') {
            steps {
                script {
                    ...
                    def warFileOriginal = "target/chess-rest-api-${version}.war"
                    def warFileRenamed = "target/chess-rest-api##${formattedVersion}.war"
