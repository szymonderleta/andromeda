...
public interface UserRepository extends JpaRepository<UserEntity, Long> {
     ...
     * used to set actual timestamp where user data(also in other tables) was edited
     *
     * @param userId user id who data was updated
     */
    @Modifying
    @Query(value = "UPDATE users SET updated_at = CURRENT_TIMESTAMP WHERE id = :userId",
            nativeQuery = true)
    ...
    @Modifying
    @Query(value = """
            UPDATE nebula.users u SET u.first_name = :firstName, u.last_name = :lastName,
