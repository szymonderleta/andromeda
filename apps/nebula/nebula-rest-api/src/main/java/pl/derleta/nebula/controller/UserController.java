...
public final class UserController {
     ...
     *
     * @param jwtToken the JWT token used for authentication, passed as a cookie value
    ...
    public ResponseEntity<NebulaUserResponse> getUserData(@CookieValue("jwtToken") String jwtToken) {
    ...
    public ResponseEntity<Response> updateUserProfile(@CookieValue("jwtToken") String jwtToken,
                                                      @RequestBody ProfileUpdateRequest profileData) {
        if (tokenProvider.isValid(jwtToken, profileData.getUserId())) {
            var response = modelAssembler.toModel(
     ...
     *
     * @param jwtToken     the JWT token used for authentication, passed as a cookie value
     * @param userSettings the new user settings to be updated, containing the user's settings information
    ...
    public ResponseEntity<Response> updateUserSettings(@CookieValue("jwtToken") String jwtToken,
                                                       @RequestBody UserSettings userSettings) {
        if (tokenProvider.isValid(jwtToken, userSettings.userId())) {
