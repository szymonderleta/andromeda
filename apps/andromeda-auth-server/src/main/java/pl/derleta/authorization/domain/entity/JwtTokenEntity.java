...
public class JwtTokenEntity {
    ...
    public JwtTokenEntity(long tokenId, UserEntity user, String token, Timestamp expirationDate) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof JwtTokenEntity that)) return false;
