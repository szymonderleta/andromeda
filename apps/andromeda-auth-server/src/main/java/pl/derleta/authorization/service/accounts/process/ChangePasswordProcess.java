...
public final class ChangePasswordProcess extends PasswordProcess {
    ...
    /**
     * Constructs a new ChangePasswordProcess instance. This process handles
     * functionalities related to changing a user's password, including validating
     * the password change request, updating the password in the repository,
     * and sending email notifications.
     *
     * @param repositoryList a set of repository instances used for interacting
     *                       with the user data and account storage.
     * @param emailService   an instance of EmailService used for sending email
     *                       notifications.
     */
    @Autowired
    public ChangePasswordProcess(Set<RepositoryClass> repositoryList, EmailService emailService) {
