...
public class UserRoleService {
    ...
    /**
     * Retrieves the user-role data identified by the given token ID.
     *
     * @param tokenId the ID of the token used to identify the user-role
     * @return the UserRole corresponding to the specified token ID
     */
    public UserRole get(final long tokenId) {
        return UserRoleApiMapper.toUserRoles(
