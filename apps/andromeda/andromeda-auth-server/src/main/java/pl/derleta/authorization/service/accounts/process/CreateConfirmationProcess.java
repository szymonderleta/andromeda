...
public abstract sealed class CreateConfirmationProcess permits UnlockAccountProcess, UserRegistrationProcess {
    ...
    /**
     * Generates and stores a confirmation token in the repository for the given user.
     *
     * @param userEntity the user entity for whom the confirmation token is created
     * @return the saved ConfirmationTokenEntity containing the generated token and associated user details
     */
