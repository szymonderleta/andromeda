...
public class UserRolesModelAssembler extends RepresentationModelAssemblerSupport<UserRoles, UserRolesResponse> {
    ...
    public UserRolesModelAssembler() {
    ...
    public UserRolesResponse toModel(UserRoles entity) {
        ...
        Link selfLink = linkTo(UserRoleController.class).slash(UserRoleController.DEFAULT_PATH).slash(model.getUser().getUserId()).withSelfRel();
        model.add(selfLink);
        return model;
    }
    ...
    private UserRolesResponse toUserRolesModel(UserRoles entity) {
        ...
        UserResponse userResponse = new UserModelAssembler().toModel(entity.user());
        model.setUser(userResponse);
        Set<RoleResponse> roleResponseSet = new HashSet<>();
        RoleModelAssembler rma = new RoleModelAssembler();
